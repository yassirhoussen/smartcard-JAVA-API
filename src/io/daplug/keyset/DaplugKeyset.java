...
import io.daplug.exception.DaplugKeysetException;
...
public class DaplugKeyset {
	 ...
	 * @exception DaplugKeysetException
	 * @return The specified key value.
	 * modifier par yassir
	 */
	public byte[] getKey(int index) throws DaplugKeysetException{
		
		switch(index){
			case 0 : return this.encKey;
			case 1 : return this.macKey;
			case 2 : return this.dekKey;
			default : throw new DaplugKeysetException("Invalid index value : " + index);
		}
	}
	 ...
	 * modifier par yassir
	 */
	public void setKey(int index, byte[] key) throws DaplugKeysetException{
