...
import io.daplug.dongle.Daplug;
...
public class Tests {
	...
	//Session
	private static Daplug daplug = new Daplug();
		
	//Session
	private static DaplugSession ds = null;
	...
	*/
	...
	public static void testDongleDetection(){
		try{
			Vector<String> v = Daplug.listAllDevices();
			ds = Daplug.selectElementListById(0);
